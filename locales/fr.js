const fr = {
  ...
  backend: {
    ...
    manifestNotAvailablePublic: "Le manifeste pour {appid} ({name}) n'est pas disponible sur les miroirs publics.",
    ...
    manifestNotAvailableManilua: "Le manifeste pour {appid} ({name}) n'est pas disponible via le miroir Manilua. Vérifiez votre clé API.",
