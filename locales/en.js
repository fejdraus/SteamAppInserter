const en = {
  ...
  backend: {
    ...
    manifestNotAvailablePublic: "Manifest for {appid} ({name}) is not available on the public mirrors.",
    ...
    manifestNotAvailableManilua: "Manifest for {appid} ({name}) is not available via the Manilua mirror. Please check your API key.",
