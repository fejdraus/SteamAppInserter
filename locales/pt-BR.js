const ptBR = {
  ...
  backend: {
    ...
    manifestNotAvailablePublic: "O manifesto para {appid} ({name}) não está disponível nos espelhos públicos.",
    ...
    manifestNotAvailableManilua: "O manifesto para {appid} ({name}) não está disponível através do espelho Manilua. Verifique sua chave API.",
